...
label_space.grid(row=0, column=2)
...
btn_explanation = Button(root, text="EXPLANATION", bd=5, width=15, bg="#0B6623", relief="groove", command=explanation)
...
btn_history = Button(root, text="LOG", bd=5, width=15, bg="cyan", relief="groove", command=history)
btn_history.grid(row=4, column=4)


def about():
    messagebox.showinfo("ABOUT","Thank you for visiting in Python project of number base calculator!")
